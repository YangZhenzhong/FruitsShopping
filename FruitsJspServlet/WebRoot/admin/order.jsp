...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/admin/css/bootstrap.min.new.css"/>
    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                <a href="${pageContext.request.contextPath }/admin/user_list.html" class="list-group-item active">用户管理</a>
                <a href="${pageContext.request.contextPath }/admin/uesr_search.html" class="list-group-item">用户搜索</a>
        ...
        <div class="col-md-10">
            ...
            <ul class="nav nav-tabs">
                ...
                <li>
                    <a href="uesr_search.html">订单搜索</a>
                </li>
            </ul>
            <table class="table">
                <thead>
                        ...
                        <td>
                            <div role="presentation" class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                   <li><a href="OrderServlet.admin.do?action=print&o_id=${o.o_id}">打印订单</a></li>
                                   <li><a href="#">修改订单</a></li>
                                </ul>
                            </div>
                        </td>
