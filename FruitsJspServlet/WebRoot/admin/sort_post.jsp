    ...
    <div class="row">
        <div class="col-md-2">
            <div class="list-group">
                ...
                <a href="${pageContext.request.contextPath }/admin/sort_post.jsp"  class="list-group-item active">添加类别</a>
            </div>
        </div>
        <div class="col-md-10">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class="active">
                    <a href="${pageContext.request.contextPath }/admin/sort_post.jsp">添加内容</a>
                </li>
            </ul>
            <form action="${pageContext.request.contextPath }/SortServlet.do?action=add" class="mar_t15" method="post">
                <div class="form-group">
                    <label for="title">类别名</label>
                    <input type="text" id="title" class="form-control"  name="s_name" placeholder="请输入类别名">
                </div>
                <div class="checkbox">
